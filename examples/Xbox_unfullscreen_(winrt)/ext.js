...
setTimeout(function() {
	...
	RunOnXAMLUIThread(function () {
        ...
        //ThrowIfFailed(appView2.add_VisibleBoundsChanged(new WinRT.TypedEventHandler((s, e) => {
		...
		Interceptor.attach(appView3.TryEnterFullScreenMode.GetAddressOf(), {
			onLeave: function (retval) {
                ...
                ThrowIfFailed(coreWindow.GetAsyncKeyState(VirtualKey_Control, keyState));
		...
		ThrowIfFailed(appView3.TryEnterFullScreenMode(Memory.alloc(Process.pointerSize)));
	});
